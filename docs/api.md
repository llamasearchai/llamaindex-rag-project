...
## llamaindex-rag-project API

### Class: Client

The main client interface for interacting with the llamaindex-rag-project library.
...
def process(self, query, options=None):
    """
    Process a query using the llamaindex-rag-project engine.
