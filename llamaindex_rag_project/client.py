"""
Client module for llamaindex-rag-project.
"""
...
class Client:
    """Main client for interacting with the llamaindex-rag-project API."""
    ...
    def __init__(self, api_key=None, base_url=None, config=None):
        ...
        self.base_url = base_url or "https://api.llamasearch.ai/llamaindex-rag-project"
